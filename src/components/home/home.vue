  ...
  <div class="wrapper" style="height: 100vh;">
          ...
          <ul class="nav navbar-nav">
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                 style="display:block;line-height: 50px;margin-top: -7px;margin-bottom: -7px;">
                <span>个人中心</span>
              </a>
    ...
    <aside class="main-sidebar" style="height: calc(100vh - 50);">
      <section class="sidebar" style="height: auto;">
        <div v-for="(item,index) in menus"
             style="height: 40px;width: 230px;background-color: #1d272b;color: #FFFFFF;display: inline-block;">
          ...
          <div class="men12" style="display: none;min-height:40px;padding-bottom: 20px;">
            <div v-for="(item2,index) in item.list"
                 style="height: 40px;width: 230px;background-color: #1a2225;color: #FFFFFF;display: inline-block;">
              <div @click="men($event)" class="men21" v-if="item2.jurFlag == '0'"
              ...
              <div class="men22" style="display: none;">
                <div v-for="(item3,index) in item2.list"
                     style="height: 40px;width: 230px;background-color: #12181a;color: #FFFFFF;display: inline-block;display: none;">
                  <div @click="men($event)" class="men3" v-if="item3.jurFlag == '0'"
                       style="margin: 10px 5px;cursor: pointer;">
										<span class="pull-left-container">
											<i class="fa fa-share pull-left"></i>
										</span>
    ...
    <footer class="main-footer">
      <div class="pull-right hidden-xs">
        ...
        <font style="vertical-align: inherit;">
          <font style="vertical-align: inherit;"> 1.0
          </font>
        </font>
      </div>
      <strong>
        ...
        <font style="vertical-align: inherit;">
          <font style="vertical-align: inherit;">后台管理</font>
        </font>
        <font style="vertical-align: inherit;">

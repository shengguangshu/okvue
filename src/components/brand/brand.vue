					...
					<div class="card-header">
						<div class="box-tools pull-right">
							<div class="input-group input-group-sm" style="width: 300px;">
								<input type="text" v-model="brandName" class="form-control" placeholder="名称">
...
<script>
	import bmadd from '@/components/brand/add.vue';
	import bmupdate from '@/components/brand/update.vue';
	...
	export default {
		...
		methods: {
			...
			getDatas: function() {
				...
				obj.$http({
					method: 'post',
					url: '/carbrand/page/' + obj.$data.pageNow,
					data: {
